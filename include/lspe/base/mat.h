...
{
	auto tb = b.transpose();
	return { dot(a[0], tb[0]), dot(a[0], tb[1]),
		dot(a[1], tb[0]), dot(a[1], tb[1]) };
}
...
{
	auto tb = b.transpose();
	return { dot(a[0], tb[0]), dot(a[0], tb[1]), dot(a[0], tb[2]),
		dot(a[1], tb[0]), dot(a[1], tb[1]), dot(a[1], tb[2]),
		dot(a[2], tb[0]), dot(a[2], tb[1]), dot(a[2], tb[2]) };
}
