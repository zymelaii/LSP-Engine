...
vec2 centroidOf(Shape shape) {
    switch (shape.type) {
        case ShapeType::eLine:
            return centroidOf(*(shape::Line *)(shape.data));
        case ShapeType::eCircle:
            return centroidOf(*(shape::Circle *)(shape.data));
        case ShapeType::ePolygen:
            return centroidOf(*(shape::Polygen *)(shape.data));
        case ShapeType::eEllipse:
            return centroidOf(*(shape::Ellipse *)(shape.data));
        case ShapeType::eBezier2:
            return centroidOf(*(shape::Bezier2 *)(shape.data));
        case ShapeType::eBezier3:
            return centroidOf(*(shape::Bezier3 *)(shape.data));
        default: {
            LSPE_DEBUG(
                "lspe::Shape: "
...
bbox2 bboxOf(Shape shape) {
    switch (shape.type) {
        case ShapeType::eLine:
            return bboxOf(*(shape::Line *)(shape.data));
        case ShapeType::eCircle:
            return bboxOf(*(shape::Circle *)(shape.data));
        case ShapeType::ePolygen:
            return bboxOf(*(shape::Polygen *)(shape.data));
        case ShapeType::eEllipse:
            return bboxOf(*(shape::Ellipse *)(shape.data));
        case ShapeType::eBezier2:
            return bboxOf(*(shape::Bezier2 *)(shape.data));
        case ShapeType::eBezier3:
            return bboxOf(*(shape::Bezier3 *)(shape.data));
        default: {
            LSPE_DEBUG("lspe::Shape: "
